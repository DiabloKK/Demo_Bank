...
public class User {
    ...
    @Email
    @NotEmpty
    @Pattern(regexp = "([a-zA-Z0-9]+(?:[._+-][a-zA-Z0-9]+)*)@([a-zA-Z0-9]+(?:[.-][a-zA-Z0-9]+)*[.][a-zA-Z0-9]{2,})",
    ...
    public User(String first_name, String last_name, String email, String password, String token, String code) {
